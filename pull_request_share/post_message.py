...
message = "<a class=\"twitter-share-button\" href='https://twitter.com/intent/tweet?button_hashtag=" + hashtags + " &text=\"" + custom_message + " " + links  + " " + at_username +  " See: " + data_url + "\'>Share on Twitter</a>"
